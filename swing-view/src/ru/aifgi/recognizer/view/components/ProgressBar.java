...
public class ProgressBar extends JPanel implements ProgressListener {
    ...
    private class MyDialog extends JDialog {
        ...
        public MyDialog() {
            super(Application.getView().getMainWindow(), Application.getBundle().getString("background.task"), true);
    ...
    public void done(final String message) {
        ...
        JOptionPane.showMessageDialog(Application.getView().getMainWindow(), message);
        setVisible(false);
        if (myDialog != null) {
